...
export const EVENT_NAMES = {
  ...
  MANUAL_VIDEO_NAVIGATION_REQUEST: "ytr:manual-video-navigation-request",
...
export type EventPayloads = {
  ...
  [EVENT_NAMES.MANUAL_VIDEO_NAVIGATION_REQUEST]: { videoId: string },
...
export const MANUAL_VIDEO_NAVIGATION_REQUEST_EVENT = EVENT_NAMES.MANUAL_VIDEO_NAVIGATION_REQUEST;
