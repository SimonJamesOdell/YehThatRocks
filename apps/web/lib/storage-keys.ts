...
export const AUTO_LOGIN_SUPPRESS_ONCE_KEY = "ytr:auto-login-suppress-once";
export const INTRO_SKIP_ONCE_AFTER_LOGIN_KEY = "ytr:intro-skip-once";
export const CHAT_OPENED_VIDEO_ACTIVITY_SUPPRESS_KEY = "ytr:chat-opened-video-activity-suppress";
