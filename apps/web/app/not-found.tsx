...
export default function NotFound() {
  return (
    <div style={{ margin: 0, background: "#0a0a0a", color: "#e8e8e8", fontFamily: "system-ui, sans-serif", display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100dvh" }}>
