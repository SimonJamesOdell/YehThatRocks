  ...
  const createPlaylistFromCategory = async () => {
    ...
    try {
      const createResponse = await createPlaylistClient({
        ...
        telemetryContext: {
          component: "category-create-playlist-button",
        },
      });
      ...
      void addPlaylistItemsClient(
        { playlistId: createdPlaylistId, videoIds: sourceVideoIds },
        { telemetryContext: { component: "category-create-playlist-button" } },
